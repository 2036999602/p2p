...
$this->title = $title;
$this->params['breadcrumbs'][] = ['label' => '项目类型管理', 'url' => ['financial-type-index']];
        ...
        <div class="box">            
            ...
            <div class="box-content text-center">
                <div class="row">
                    ...
                    <p class="text-left">
                        <?php
                        echo \yii\bootstrap\Html::a('添加', ['financial-type-add'], ['class' => 'btn btn-primary', 'alt' => '添加']) . "&nbsp;&nbsp;";
                        echo \yii\bootstrap\Html::a('批量删除', 'javascript:void(0)', ['onclick' => "commonDataOperate('post','".Yii::$app->getRequest()->getCsrfToken()."','" . yii\helpers\Url::to(['financial-type-delete']) . "','确定要删除所选么？','selection[]','input','checked',false,false,false,true)", 'class' => 'btn btn-primary', 'alt' => '批量删除']) . "&nbsp;&nbsp;";
                        ...
                        echo \yii\bootstrap\Html::a('编辑', 'javascript:void(0)', ['onclick' => "commonDataOperate('get','','" . yii\helpers\Url::to(['financial-type-update']) . "','','selection[]','input','checked',true)", 'class' => 'btn btn-primary', 'alt' => '编辑']) . "&nbsp;&nbsp;";
