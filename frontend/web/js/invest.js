...
require(["jquery","Navactive", "tab","validform","pages","sideshare","hDialog","questiontest"],
  function($){
    //页面顶部 我的账户下拉效果
    ...
    //高端投资筛选条件选项
      $('.annualRateType').find('dd').click(function(){
          $('.annualRateType').find('dd').attr('class','');
          $(this).attr('class','filt_active');
      });

      $('.showDeadlineType').find('dd').click(function(){
          $('.showDeadlineType').find('dd').attr('class','');
          $(this).attr('class','filt_active2');
      });

      $('.sorting .investType').find('dd').click(function(){
          $('.investType').find('dd').attr('class','');
          $('.investType').find('dd').children("i").attr('class','');
          $('.investType').find('dd').children(".sort_arrow").css("display","none");

          $(this).attr('class','type_active').children('.sort_arrow').css('display','block');

          if ($(this).children("i").attr("leng") != "desc") {
              $(this).children("i").attr('class','fa fa-long-arrow-down');
              $(this).children("i").attr("leng", "desc");
          } else {
              $(this).children("i").attr('class','fa fa-long-arrow-up');
              $(this).children("i").attr("leng", "");
          }
      });
    //投资页面tab选项卡
