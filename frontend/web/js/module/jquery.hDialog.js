...
;(function($, window, document, undefined) {
	...
	methods = {
        ...
        open: function (o,T) {
			...
			//弹框标题
			if(o.title != '') headTpl = '<div id="HTitle" style="padding:10px 45px 10px 12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;border-radius:10px;">'+o.title+'</div>';
